"""Native cognis-connect emit for guardpost — forward findings to any platform.

Maps guardpost's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    guardpost ... --format json | guardpost-emit --to stix
    guardpost-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
