#!/usr/bin/env sh
# Universal installer for guardpost. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/guardpost.git"
echo "Installing guardpost ..."
